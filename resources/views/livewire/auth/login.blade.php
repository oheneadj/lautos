<x-layouts::auth :title="__('Log in')">
    <div class="flex flex-col gap-6">
        ...
        <a href="{{ route('auth.google.redirect', ['intent' => 'login']) }}" class="flex items-center justify-center gap-3 w-full rounded-xl border border-base-content/10 bg-base-100 py-[10px] text-[14px] font-semibold text-base-content hover:bg-base-200 transition-colors">
