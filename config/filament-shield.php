...
return [
    ...
    */
    ...
    'super_admin' => [
        'enabled' => true,
        'name' => 'super_admin',
        // I bypass per-permission checks for super_admin via a Gate::before rather than
        // seeding every generated permission onto the role — this is a single-admin-role app.
