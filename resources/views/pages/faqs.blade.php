<x-layouts.public title="Frequently Asked Questions">
    ...
    <section class="relative min-h-[50vh] flex items-center bg-[#1a1c23] overflow-visible">
        ...
        <div class="relative z-10 max-w-[90rem] mx-auto px-4 lg:px-8 w-full py-20">
            <div class="max-w-2xl">
                <span class="inline-block px-3 py-1 mb-6 rounded-full bg-primary/20 text-primary text-xs font-bold uppercase tracking-widest border border-primary/20">Support & Guides</span>
            ...
            <div class="lg:col-span-4">
                ...
                <div class="bg-gray-900 rounded-2xl p-8 relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <a href="{{ route('contact') }}" class="inline-flex items-center justify-center bg-primary text-white text-sm font-bold py-3.5 px-6 rounded-lg hover:bg-red-700 transition-all duration-200 w-full shadow-lg shadow-primary/20">
                            Contact Support
                        </a>
                    </div>
                </div>
