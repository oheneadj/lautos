<x-layouts.public title="Refund & Cancellation Policy">
    ...
    <section class="relative min-h-[50vh] flex items-center bg-[#1a1c23] overflow-visible">
        <div class="absolute top-0 right-0 w-full lg:w-[60%] h-full z-0">
            <img src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=2000&q=80"
                alt="Refund Policy" class="w-full h-full object-cover opacity-30 lg:opacity-60">
        ...
        <div class="relative z-10 max-w-[90rem] mx-auto px-4 lg:px-8 w-full py-20">
            <div class="max-w-2xl">
                <span class="inline-block px-3 py-1 mb-6 rounded-full bg-primary/20 text-primary text-[12px] font-bold uppercase tracking-widest border border-primary/20">Legal Hub</span>
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight tracking-tight">
                    Refund Policy <br><span class="text-primary">Fair & Simple</span>
                </h1>
                <p class="text-lg text-white/70 font-medium">
                    Understand our policies regarding order cancellations and refunds before committing to a purchase.
                </p>
            </div>
        </div>
            ...
            <aside class="w-full lg:w-72 flex-shrink-0">
                <div class="sticky top-24 bg-white rounded-2xl p-8 shadow-xl shadow-gray-200/50 border border-gray-100 relative overflow-hidden">
                    ...
                    <nav class="space-y-2">
                        ...
                        <a href="{{ route('pages.refund-policy') }}" class="flex items-center gap-3 px-4 py-3 bg-primary/10 text-primary rounded-xl font-bold text-[14px] transition-colors">
                        ...
                        <a href="{{ route('pages.fraud-awareness') }}" class="flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-100 rounded-xl font-medium text-[14px] transition-colors">
            ...
            <div class="flex-1">
                <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8 md:p-12 lg:p-16 relative overflow-hidden">
                    <div class="prose prose-lg prose-gray max-w-none">
                        ...
                        <div class="mb-12">
                            <h2 class="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b border-gray-100">1. Order Cancellations</h2>
                            <p class="text-[16px] text-gray-600 leading-relaxed mb-4">
                                Once a vehicle has been paid for and the shipment process has begun (e.g. booked on a vessel), cancellations are generally not permitted.
                            </p>
                            <p class="text-[16px] text-gray-600 leading-relaxed mb-4">
                                If you wish to cancel an order before it has been processed, please contact our support team immediately. Please note that an administrative fee may apply.
                            </p>
                        </div>
                ...
                <div class="mt-8 bg-white rounded-2xl p-8 shadow-xl shadow-gray-200/50 border border-gray-100 relative overflow-hidden flex flex-col sm:flex-row items-center justify-between gap-6">
                    <div>
                        <h4 class="text-lg font-bold text-gray-900 mb-1">Questions about refunds?</h4>
                        <p class="text-[14px] text-gray-600 font-medium">Our support team is happy to clarify any legal or policy questions.</p>
                    </div>
