...
return [
    ...
    'backup' => [
        ...
        'destination' => [
            ...
            /*
             * The disk names on which the backups will be stored. I default to
             * 'local' so this works out of the box on shared hosting, but on
             * production this should point somewhere off-server (e.g. 's3')
             * so a backup actually survives if the hosting account is lost.
             */
            'disks' => [
