<x-layouts.public title="How It Works">
    ...
    <section class="max-w-[90rem] mx-auto px-4 lg:px-8 py-16 lg:py-24">
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <p class="text-[16px] text-gray-500 font-medium">Follow these five simple steps to get your dream car delivered directly to you from Japan or Korea.</p>
        </div>
    ...
    <section class="bg-gray-50 border-t border-gray-100 py-16 lg:py-20 mt-8">
        <div class="max-w-[90rem] mx-auto px-4 lg:px-8 text-center">
            ...
            <a href="{{ route('cars.index') }}" class="inline-flex items-center justify-center bg-primary text-white text-[15px] font-bold py-4 px-10 rounded-lg hover:bg-primary/90 transition-all duration-200 shadow-lg shadow-primary/30">
                Browse Inventory
            </a>
        </div>
    </section>
    ...
    <section class="py-20 bg-[#1a1c23] relative overflow-hidden border-t border-gray-800">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a wire:navigate href="{{ route('cars.index') }}" class="w-full sm:w-auto inline-flex items-center justify-center bg-primary text-white text-[15px] font-bold py-4 px-8 rounded-lg hover:bg-red-700 transition-all duration-200 shadow-lg shadow-primary/30">
                    Browse Inventory
                </a>
                <a wire:navigate href="{{ route('contact') }}" class="w-full sm:w-auto inline-flex items-center justify-center bg-white/10 text-white border border-white/20 text-[15px] font-bold py-4 px-8 rounded-lg hover:bg-white/20 transition-all duration-200">
                    Contact Support
                </a>
            </div>
        </div>
